...
function Hero() {
  return (
    ...
    <div className="hidden lg:block">
      <Image src='/profile1.png' alt="profile1" width={100} height={100}
      className="h-[100px] object-cover rounded-full absolute right-36 " />
        <Image src='/profile2.png' alt="profile1" width={100} height={100}
      className="h-[100px] object-cover rounded-full absolute top-48 left-16 " />
        <Image src='/profile3.png' alt="profile1" width={100} height={100}
      className="h-[100px] object-cover rounded-full absolute bottom-20 left-36 " />
        <Image src='/profile4.png' alt="profile1" width={100} height={100}
      ...
      <div className="text-center max-w-3xl">
        ...
        <h2 className="text-xl text-slate-500 ">
          Scheduly is your scheduling automation platform for eliminating 
           the back-and-forth emails to find the perfect time — and so 
            much more.
        </h2>
        <div className=" flex gap-4 flex-col mt-5">
          <h3 className="text-sm">Sign Up free with Google and Facebook</h3>
          <div className="flex justify-center gap-8">
            <Button className="p-7 flex gap-3" >
